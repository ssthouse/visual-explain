...
const headDomNode = new DomNode('head', null)
htmlDomNode.addChild(headDomNode)
const titleDomNode = new DomNode('title', null)
const styleDomNode = new DomNode('style', null)
headDomNode.addChild(titleDomNode)
headDomNode.addChild(styleDomNode)
